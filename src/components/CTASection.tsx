export default function CTASection() {
  return (
    <section className="py-16 sm:py-20 bg-gradient-to-r from-brand-blue to-blue-800 relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <a href="tel:+17148535534" className="inline-block bg-white text-brand-blue font-bold px-8 py-4 rounded-xl text-lg hover:bg-gray-100 transition shadow-xl">
            📞 (714) 853-5534
          </a>
